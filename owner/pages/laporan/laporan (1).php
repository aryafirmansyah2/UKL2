  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- <div class="card-body"> -->
        ...
        <!-- <a href="transaksi-konfirm-laman.php"><button type="button" class="btn btn-outline-primary btn-fw" style="margin-left: 10px;">Konfirmasi</button></a> -->
        <!-- <h4 class="card-title" style="margin-top: 40px;">Laporan</h4> -->
        
      <!-- </div> -->
      <div class="main-panel"> 
        <div class="content-wrapper">
        <a href="laporan-cetakproses.php"><button type="button" class="btn btn-primary">Cetak</button></a>
        <form class="forms-sample" method="POST" action="">
            <div class="form-group">
              <label for="exampleSelectGender" style="font-weight: 600;">Pilih Outlet</label>
              <select class="form-control" id="exampleSelectGender" name="outlet">
              <?php
              include "koneksi.php";
