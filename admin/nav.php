    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/pages/outlet/outlet.php">
            <i class="ti-home menu-icon"></i> 
              <span class="menu-title">Outlet</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/pelanggan/pelanggan.php">
            <i class="ti-user menu-icon"></i>
              <span class="menu-title">Pelanggan</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/paket/paket.php">
              <i class="ti-package menu-icon"></i>
              <span class="menu-title">Paket</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/pengguna/pengguna.php">
              <i class="ti-user menu-icon"></i>
