          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form action="./proces/ubah.php" method="POST" class="forms-sample">
                        <div class="form-group">
                        <input type="hidden" name="id" value="<?=$dt_member['id']?>">
                        <label for="exampleInputName1">Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="nama" value= "<?=$dt_member['nama']?>">
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail3">Alamat</label>
                        <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Alamat" name="alamat" value= "<?=$dt_member['alamat']?>">
                        </div>
                        <div class="form-group">
                        ...
                        ?>
                        <select class="form-control form-control-lg" id="exampleFormControlSelect1" placeholder="Jenis Kelamin" name="jk">
                        <?php 
                        ...
                        <div class="form-group">
                        <label for="exampleInputPassword4">tlp</label>
                        <input type="number" class="form-control" id="exampleInputPassword4" placeholder="tlp" name="tlp"value= "<?=$dt_member['tlp']?>">
                        </div>
