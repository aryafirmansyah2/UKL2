            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold"><?= $_SESSION['nama'] ?></span></h1>
        ...
        <div class="container-fluid page-body-wrapper">
          ...
          <li class="nav-item">
            ...
            <div class="card-body">
                ...
                ?>
                <h4 class="card-title" style="margin-top: 30px;">Konfirmasi Pembayaran</h4>
                <!-- <p class="card-description">
                    Basic form layout
                  </p> -->
                <form class="forms-sample" method="POST" action="transaksi-konfirm-prosesbayar.php?id=<?=$_GET['id']?>">
                    <div class="form-group">
                        <!-- <label for="exampleInputUsername1">Nama</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" name="nama" placeholder="Username"> -->
                        <label for="exampleInputUsername1">Nama Pelanggan</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" name="nama" placeholder="Username" value="<?= $dt_transaksi['nama_member']?>" disabled>
                    </div>
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="exampleInputEmail1" name="uname" placeholder="Email"> -->
                        ...
                        <input type="text" class="form-control" id="exampleInputUsername1" name="invoice" placeholder="Username" value="<?= $dt_transaksi['kode_invoice']?>" disabled>
                    </div>
                    <div class="form-group">
                        <!-- <label for="exampleInputEmail1">Password</label>
                      <input type="email" class="form-control" id="exampleInputEmail1" name="pass" placeholder="Password"> -->
                        <label for="exampleInputUsername1">Jumlah Tagihan</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" name="jumlah" placeholder="Username" value="<?= $dt_transaksi['total_harga']?>" disabled>
                    </div>
                    <div class="form-group">
                        <!-- <label for="exampleInputEmail1">Password</label>
                      <input type="email" class="form-control" id="exampleInputEmail1" name="pass" placeholder="Password"> -->
                        <label for="exampleInputUsername1">Jumlah Bayar</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" name="bayar" placeholder="Username">
                    </div>
                    ...
                    <a href="transaksi-konfirm-laman.php" class="btn btn-light">Back</a>
                </form>
            </div>
