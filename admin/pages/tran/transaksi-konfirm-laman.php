...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial // HERE BODY -->
      <div class="card-body">
        <h4 class="card-title" style="margin-top: 30px;">Konfirmasi Transaksi</h4>
            ...
            <tbody>
              ...
              while ($data_transaksi = mysqli_fetch_array($qry_transaksi)) {
                ...
                <tr>
                  ...
                  <td><a href="transaksi-konfirm-pilih.php?id=<?= $data_transaksi['id_transaksi'] ?>" class="btn btn-outline-primary btn-fw" style="margin-right: 15px;">Pilih</a></td>
                </tr>
              <?php
              }
              ?>
