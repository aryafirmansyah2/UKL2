...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial // HERE BODY -->
      <div class="card-body">
                  <h4 class="card-title" style="margin-top: 30px;">Tambah Pelanggan</h4>
                  ...
                  <form class="forms-sample" action="transaksi-prosestambah.php?id=<?=$_GET['id']?>" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="invoice" placeholder="Email" value="<?='CCIAN' . Date('Ymdsi');?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" name="jumlah" placeholder="Email">
                    </div>
                    <div class="form-group">
