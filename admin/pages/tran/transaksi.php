...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <!-- partial // HERE BODY -->
      <div class="card-body">
        <a href="transaksi-pilihpelanggan.php"><button type="button" class="btn btn-primary">Tambah</button></a>
        ...
        <h4 class="card-title" style="margin-top: 40px;">Daftar Transaksi</h4>
