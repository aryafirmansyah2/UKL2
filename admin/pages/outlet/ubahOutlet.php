            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form action="./proces/ubah.php" method="POST" class="forms-sample">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="nama" value= "<?=$dt_outlet['nama']?>">
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail3">Alamat</label>
                        <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Alamat" name="alamat" value= "<?=$dt_outlet['alamat']?>">
                        </div>
                        <div class="form-group">
                        <label for="exampleInputPassword4">tlp</label>
                        <input type="number" class="form-control" id="exampleInputPassword4" placeholder="tlp" name="tlp"value= "<?=$dt_outlet['tlp']?>">
                        </div>
