            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <form action="proces/add.php" method="POST" class="forms-sample">
                        ...
                        <select class="form-control form-control-lg" id="exampleFormControlSelect1" placeholder="Jenis" name="jenis">
                            <option></option>
                        ...
                        <div class="form-group">
                        <label for="exampleFormControlSelect1">Nama Paket</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Nama Paket" name="paket">
                        </div>
                        <div class="form-group">
                        ...
                        <a href="./pelanggan.php"  type="button" class="btn btn-outline-secondary btn-lg btn-block">Batal</a>                     
                    </form>
