            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-dark" onclick="location.href='./confrimdata.php'">Confrim </button>
                  </td>
            ...
            <tbody>
              ...
              while ($data_transaksi = mysqli_fetch_array($qry_transaksi)) {
                ...
                <td><?=$no?></td>
                  ...
                  <td><a href="./detaildata.php?id=<?= $data_transaksi['id_transaksi'] ?>" class="btn btn-outline-primary btn-fw" style="margin-right: 15px;">Detail</a></td>
                </tr>
              <?php
              }
              ?>
