          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-dark" onclick="location.href='./addTransaksi.php'">Add Outlet</button>
            ...
            $no++;?>
                    <tr> 
                        ...
                        <td><a href='./addTransaksi.php?id=<?=$data_member['id']?>' type="button" class="btn btn-dark btn-lg btn-block">Pilih</a></td>
