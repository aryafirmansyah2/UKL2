...
if ($_POST) {
    ...
    if (empty($jumlah)) {
        echo "<script>alert('Jumlah tidak boleh kosong');location.href='../addTransaksi.php.php?id=".$_GET['id']."';</script>";
    }
    else {
        ...
        if ($transaksi) {
            ...
            echo "<script>alert('Transaksi Gagal');location.href='../transaksi.php?id=".$_GET['id']."';</script>";
        }
    }
}