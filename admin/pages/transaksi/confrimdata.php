  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <!-- <td>
                  <button type="button" class="btn btn-dark" onclick="location.href='./pilihMember.php'">Add Pengguna</button>
                  <button type="button" class="btn btn-dark" onclick="location.href='./confrimdata.php'">Confrim Pembayaran</button>
                  </td> -->
              ...
              while ($data_transaksi = mysqli_fetch_array($qry_transaksi)) {
                ...
                <tr>
                  ...
                  <td><a href="./confrimbayar.php?id=<?= $data_transaksi['id_transaksi'] ?>" class="btn btn-outline-primary btn-fw" style="margin-right: 15px;">Pilih</a></td>
                </tr>
              <?php
              }
              ?>
        ...
        <a href="transaksi.php"><button type="button" class="btn btn-primary" style="margin-top: 20px;">Back</button></a>
      </div>