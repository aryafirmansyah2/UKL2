  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="card-body">
        ...
        <a href="laporan.php"><button type="button" class="btn btn-outline-primary btn-fw" style="margin-left: 10px;">Back</button></a> -->
        <h4 class="card-title">Laporan Lengkap Laundry</h4>
